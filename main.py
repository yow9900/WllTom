...
# FIX: Use environment variable NAMES (e.g., 'BOT_TOKEN') instead of the values.
# Assuming the user has set environment variables named 'BOT_TOKEN' and 'WEBHOOK_URL'
BOT_TOKEN = os.environ.get('8107285502:AAHzzp-UCcAnciMwf3xnSOMizV7lqMc1fq0')
